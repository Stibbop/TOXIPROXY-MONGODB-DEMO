import { ICreateToxicBody, IUpdateToxicBody } from "./interfaces";
import { AxiosInstance } from "axios";
export type Direction = "upstream" | "downstream";
export type Type = "latency" | "down" | "bandwidth" | "slow_close" | "timeout" | "slicer" | "limit_data" | "reset_peer";
/**
...
export default class Toxic<T> {
     ...
     */
    update(body: IUpdateToxicBody<T>): Promise<Toxic<T>>;
}
